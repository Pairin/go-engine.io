...
[![GoDoc](http://godoc.org/github.com/Pairin/go-engine.io?status.svg)](http://godoc.org/github.com/Pairin/go-engine.io) [![Build Status](https://travis-ci.org/googollee/go-engine.io.svg)](https://travis-ci.org/googollee/go-engine.io)
...
```bash
go get github.com/Pairin/go-engine.io
```

Import it with:

```go
import "github.com/Pairin/go-engine.io"
```
